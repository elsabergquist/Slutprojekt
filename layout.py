...
def layout_all(fs, col1, col2, col3, col4, col5):
    layout_startsida = layout_start()
    layout_spelsida = layout_spel(fs, col1, col2, col3)
    layout_vinstsida = layout_vinst()
    layout_maxgissningar = layout_max(fs)
    layout_highscorelista = layout_high(fs, col4, col5)  
...
def layout_start():
    ...
    return layout_startsida

def layout_spel(fs, col1, col2, col3):
    layout_spelsida = [
...
def layout_max(fs):
    ...
    return layout_maxgissningar


def layout_high(fs, col4, col5):
